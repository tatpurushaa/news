...
import {WebVieww} from './../../routes/webvieww';
...
const BASE_URL = 'https://newscatcher.p.rapidapi.com/v1/search?q=a&lang=hi&sort_by=relevancy&country=IN&topic=news&page=1&media=True';
...
const TopNewsScreen = ({navigation}) => {
 ...
 const rowRendererr = (item) => {
  navigation.navigate('WebVieww',{
    params: { item: item },
  });
  // return <WebVieww link={item.link}/>
  // console.log({item});
    };
