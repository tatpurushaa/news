...
const BASE_URL = 'https://newscatcher.p.rapidapi.com/v1/search?q=a&lang=hi&sort_by=relevancy&country=IN&topic=economics&page=1&media=True';
...
const EconomicsScreen = ({navigation}) => {
